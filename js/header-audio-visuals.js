...
(function() {
  ...
  MP3_PATH = 'https://dl.dropboxusercontent.com/s/5in22f9665v3x6t/crossing-winds.MP3';
  ...
  Particle = (function() {
    ...
    Particle.prototype.draw = function(ctx) {
      ...
      alpha = this.alpha * this.energy * 1;
      ...
      ctx.save();
      ctx.beginPath();
      ctx.translate(this.x + cos(this.rotation * this.speed) * 10, this.y);
      ctx.rotate(this.rotation);
      ctx.scale(this.smoothedScale * this.level, this.smoothedScale * this.level);
      ctx.moveTo(this.size * 0.001, 0);
      ctx.lineTo(this.size * -0.001, 0);
      ctx.lineWidth = 1;
      ctx.lineCap = 'round';
